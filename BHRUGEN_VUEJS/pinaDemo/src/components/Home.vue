<template>
  <div class="text-center">
    ...
    <br/>
    <span class="text-success pb-3 h3" v-if="gameStore.getScore >= gameStore.maxHealth">You Won!</span>
    <span class="text-danger pb-3 h3" v-else-if="gameStore.getScore < 0">You Lost</span>
    ...
    <div class="col-6 offset-3 pt-2" v-else>
